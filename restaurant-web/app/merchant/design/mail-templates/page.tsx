...
export default function MailTemplatesPage() {
    ...
    return (
        <div className="min-h-screen">
            <h1 className="text-2xl font-semibold mb-6 text-gray-900">Mail Templates</h1>
            {/* Modal setup columns */}
            <ListSetupModal
                open={openSetupModal}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="flex items-center p-4 border-b border-gray-200">
                    <ActionBar newLabel="New" secondaryLabel="" />
                </div>
                {/* Table */}
                <DataTable
                    columns={mailTemplateTableData}
                    emptyText="There are no mail templates available."
                    colSpan={4}
                />
                {/* Footer */}
