...
import { Users, Store, Utensils, TrendingUp, DollarSign, ShoppingCart, UserCheck, AlertCircle } from "lucide-react";
				...
				<div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
					...
					<ResponsiveContainer width="100%" height={300}>
						<LineChart data={platformGrowthData}>
							...
							<Line type="monotone" dataKey="merchants" stroke="#8B5CF6" strokeWidth={2} name="Merchants" />
							<Line type="monotone" dataKey="restaurants" stroke="#10B981" strokeWidth={2} name="Restaurants" />
						</LineChart>
					</ResponsiveContainer>
				</div>
				...
				<div className="space-y-4">
					<div className="flex items-center gap-4 pb-4 border-b border-gray-200 dark:border-gray-700">
						...
						<div className="flex-1">
							<p className="text-sm font-medium text-gray-900 dark:text-white">Merchant mới được phê duyệt</p>
					...
					<div className="flex items-center gap-4 pb-4 border-b border-gray-200 dark:border-gray-700">
						...
						<div className="flex-1">
							<p className="text-sm font-medium text-gray-900 dark:text-white">Nhà hàng mới được đăng ký</p>
