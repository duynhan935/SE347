	...
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-3xl font-bold text-gray-900 dark:text-white">Quản lý Sizes</h1>
					<p className="text-gray-600 dark:text-gray-400 mt-1">Quản lý kích thước mặc định cho món ăn</p>
				</div>
				<button
					onClick={() => {
						setEditingSize(null);
				...
				{loading ? (
					...
					<div className="overflow-x-auto">
						<table className="w-full">
							...
							<tbody className="divide-y divide-gray-200 dark:divide-gray-700">
								{filteredSizes.map((size) => (
									<tr key={size.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
						...
						{filteredSizes.length === 0 && (
							<div className="text-center py-12 text-gray-500 dark:text-gray-400">Không tìm thấy size nào</div>
						)}
					</div>
				)}
			</div>
