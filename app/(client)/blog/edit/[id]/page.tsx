        ...
        try {
            ...
            const message =
                ...
                typeof (error as { response?: { data?: { message?: string } } }).response?.data?.message === "string"
                    ? (error as { response?: { data?: { message?: string } } }).response?.data?.message
                    : undefined;
            toast.error(message || "Failed to update blog. Please try again.");
        } finally {
            setLoading(false);
        }
    };
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-md p-6 md:p-8 space-y-6">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                            Content Images{" "}
                            <span className="text-xs text-gray-500 font-normal">(Optional, up to 10 images)</span>
                        </label>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Write your article in Markdown format. Use{" "}
                            <code className="bg-gray-100 px-1 rounded">#</code> for headings,{" "}
                            <code className="bg-gray-100 px-1 rounded">**bold**</code> for bold text, and more. Click
                            the image button to upload images.
                        </p>
                    </div>
