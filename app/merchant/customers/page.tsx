...
const customerColumns = [
    ...
    { label: "Customer Group", checked: true },
...
export default function CustomersPage() {
    ...
    const customerTableData = [
        ...
        { label: "Customer Group", sortable: true, key: "customerGroup" },
    ...
    return (
        <div className="min-h-screen">
            <h1 className="text-2xl font-semibold mb-6 text-gray-900">Customers</h1>
            {/* Modal setup columns */}
            <ListSetupModal open={openSetupModal} onClose={() => setOpenSetupModal(false)} columns={customerColumns} />
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                {/* Action Bar */}
                <div className="flex justify-between items-center p-4 border-b border-gray-200">
                    <ActionBar newLabel="New" secondaryLabel="Groups" />
                ...
                {/* Table */}
                <DataTable columns={customerTableData} emptyText="There are no customers available." colSpan={7} />
                {/* Footer */}
