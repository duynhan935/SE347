...
const mealtimeColumns = [
    ...
    { label: "Start Time", checked: true },
    { label: "End Time", checked: true },
    { label: "Start At", checked: true },
    { label: "End At", checked: true },
...
export default function MealsTimePage() {
    const [openSetupModal, setOpenSetupModal] = useState(false);

    const mealtimeTableData = [
        { label: "Name", sortable: true, key: "name" },
        { label: "Validity", sortable: true, key: "validity" },
        { label: "Start Time", sortable: true, key: "startTime" },
        { label: "End Time", sortable: true, key: "endTime" },
        { label: "Start At", sortable: true, key: "startAt" },
        { label: "End At", sortable: true, key: "endAt" },
    ...
    return (
        <div className="min-h-screen">
            <h1 className="text-2xl font-semibold mb-6 text-gray-900">Mealtimes</h1>
            {/* Modal setup columns */}
