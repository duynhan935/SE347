	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			const restaurantData: RestaurantData = {
				...formData,
				openingTime: formData.openingTime.includes(":") && formData.openingTime.split(":").length === 2
					? `${formData.openingTime}:00`
					: formData.openingTime,
				closingTime: formData.closingTime.includes(":") && formData.closingTime.split(":").length === 2
