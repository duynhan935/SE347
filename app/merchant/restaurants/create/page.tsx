    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Tạo Nhà Hàng Mới</h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-1">Điền thông tin để tạo nhà hàng mới</p>
                </div>
            </div>
            ...
            >
                <div className="space-y-6">
                    ...
                    {/* Description */}
                    <div>
                        <label className="block text-sm font-medium text-gray-900 dark:text-white mb-2">Mô Tả</label>
                        <textarea
                            rows={4}
                        ...
                        <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg p-8 text-center">
                            {imagePreview ? (
                                ...
                                <>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 mb-2">Click để chọn ảnh</p>
