        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 p-4 lg:p-0">
                ...
                <div className="flex flex-col">
                    ...
                    {selectedSize ? (
                        <p className="text-3xl font-bold text-brand-purple my-6">${selectedSize.price.toFixed(2)}</p>
                    ) : (
                        <p className="text-3xl font-bold text-red-500 my-6">Please select a size</p>
                    )}

                    <p className="text-gray-500 mt-4 text-md leading-relaxed mb-5">{foodItem.description}</p>
                    ...
                    <div className="mt-auto">
                        ...
                        <label htmlFor="special-instructions" className="font-semibold text-gray-800">
