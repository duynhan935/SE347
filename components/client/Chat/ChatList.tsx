                                                        ...
                                                        return (
                                                                <button
                                                                        ...
                                                                        className={`w-full p-4 text-left transition-colors relative hover:bg-gray-50 dark:hover:bg-gray-800 ${
                                                                                isSelected
                                                                                        ? "bg-purple-50 border-l-4 border-brand-purple dark:bg-gray-800"
                                                                                        : ""
                                                                        }`}
                                                                >
                                                                        <div className="flex items-start gap-3">
                                                                                ...
                                                                                <div className="flex-1 min-w-0">
                                                                                        <div className="flex items-center justify-between mb-1">
                                                                                                <p className={`text-sm font-semibold truncate ${unreadCount > 0 && !isSelected ? "font-bold" : "text-gray-900 dark:text-white"}`}>
                                                                                                        {partnerName}
                                                                                                </p>
                                                                                        ...
                                                                                        {room.lastMessage && (
                                                                                                <p className={`text-sm truncate ${unreadCount > 0 && !isSelected ? "font-medium text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"}`}>
                                                                                                        {
                                                                                                                room.lastMessage
                                                                                                        }
                                                                                                </p>
