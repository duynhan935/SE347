...
import { LayoutDashboard, UtensilsCrossed, ShoppingCart, BarChart3, Package, MessageSquare, X } from "lucide-react";
...
export default function ManagerSidebar({ sidebarOpen, setSidebarOpen }: ManagerSidebarProps) {
	const pathname = usePathname();

	const menuItems = [
		{ href: "/manager/dashboard", label: "Dashboard", icon: LayoutDashboard },
		{ href: "/manager/menu", label: "Quản Lý Thực Đơn", icon: UtensilsCrossed },
		{ href: "/manager/orders", label: "Đơn Hàng", icon: ShoppingCart },
		{ href: "/manager/inventory", label: "Kho Hàng", icon: Package },
		{ href: "/manager/chat", label: "Hỗ Trợ Khách Hàng", icon: MessageSquare },
